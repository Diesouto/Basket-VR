...
public class Basket : NetworkBehaviour
{
    ...
    [SerializeField] float minEventsDuration = 5f;              // Duraci�n m�nima de los eventos posibles de la canasta
    [SerializeField] float maxEventsDuration = 10f;             // Duraci�n m�xima de los eventos posibles de la canasta
    [SerializeField] float minEventCooldownTime = 5f;          // Duraci�n m�nima entre eventos posibles de la canasta
    [SerializeField] float maxEventCooldownTime = 10f;         // Duraci�n m�xima entre eventos posibles de la canasta
    ...
    // Aumenta el tama�o de la canasta de forma aleatoria, hasta el m�ximo permitido
    void IncreaseSize()
    {
    ...
    void StartShake()
    {
        moveSpeed = Random.Range(5f, 10f); // r�pido
    }
    ...
    // Teletransporta la canasta a una posici�n aleatoria dentro de un �rea determinada
    void Teleport()
    {
